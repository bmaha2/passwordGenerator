...
var confirmCount = 0;        // count of how many confimations were selected
 ...
 function lowerCaseGenerator(pwdLength) {
 ...
 function upperCaseGenerator(pwdLength) {
 ...
 function numberGenerator(pwdLength) {
 ...
 function specailCharacterGenerator(pwdLength) {
...
function randomPickSingleChar(array) {
  ...
  if (pwdLength !== null) { //starts the program if the user inputs number of characters for the password
   ...
   specailCharacterGenerator(pwdLength);
   console.log(specialCharacterArr);
   console.log(singleCharacterArr);
   ...
   //If the all the options are selected to negative alert to select at least one option
    ...
    //.slice(0,(passwordArray.length/confirmCount)-singleCharacterArr.length).concat(singleCharacterArr).join("");
